  ...
  test('return the expected values', async () => {
    ...
    expect(actual).toEqual(
      expect.objectContaining({
        ...
        url: 'https://raw.githubusercontent.com/block360/community/mueed/governance/polls/Adjust%20the%20Dust%20Parameter%20-%20January%2018%2C%202021.md',
        slug: 'QmWPAu5z',
  ...
  test('return the expected values for an old uncategorized poll', async () => {
    ...
    expect(actual).toEqual(
      expect.objectContaining({
        ...
        url: 'https://raw.githubusercontent.com/block360/community/mueed/governance/polls/Add%20an%20ETH-B%20Vault%20Type%20-%20October%205%2C%202020.md',
        slug: 'QmXhKW6B',
