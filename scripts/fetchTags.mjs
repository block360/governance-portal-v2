...
async function main() {
  try {
    ...
    //poll tags
    const urlTags =
      'https://raw.githubusercontent.com/block360/community/mueed/governance/polls/meta/tags.json';
    ...
    const urlDelegateTags =
      'https://raw.githubusercontent.com/block360/community/mueed/governance/delegates/meta/tags.json';
